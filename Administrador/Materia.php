...
class Materia{
    ...
    public function seleccionaMaestro(){
        ...
        echo"<form action=Form1-Materia.php method=POST name=maestro>";
    ...
    public function materiasAsignadas($maestro){
        ...
        for($i = 0; $i < $cuantos; $i++){
            ...
            echo"<tr>";
            echo"<td>$materia</td><td><a href='Eliminar-Mat.php?id=$id_mat'>Eliminar</a></td>";
            echo"</tr>";
        }
        echo"</div>";
    }
    ...
    public function asignarMateriaMaestro($maestro){
        echo"<div class='table-responsive sok_font'>";
        echo"<form action=Form-Materia.php method=POST name=materias>";
        echo"<table class=table table-striped>";
        echo"<tr><th>Asignar materias</th></tr>";
